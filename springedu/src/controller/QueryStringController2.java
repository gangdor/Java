...
public class QueryStringController2 {
	...
	@RequestMapping(value = "/querystring6", method = RequestMethod.POST)
	...
	public ModelAndView locale(Locale l){
		ModelAndView mav = new ModelAndView();
		mav.addObject("spring", "Locale Ã³¸®.........." + l.getDisplayCountry() + "_" + l.getDisplayLanguage());
		mav.setViewName("queryView2");
		return mav;
