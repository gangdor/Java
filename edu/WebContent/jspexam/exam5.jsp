...
<body>
	<h1>선언문 태그 학습</h1>
	<form method="get" action="/edu/jspexam/exam5.jsp">
	<input type="number"  name="num1" placeholder="num1입력" required>
	<input type="number"  name="num2" placeholder="num2입력" required>
	<input type="submit">
	</form>
